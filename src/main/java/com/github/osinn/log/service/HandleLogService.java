package com.github.osinn.log.service;
...
import com.github.osinn.log.dto.IpInfo;
import com.github.osinn.log.dto.SysLogDTO;
import com.github.osinn.log.entity.base.SysLogSource;
import com.github.osinn.log.annotation.SysLog;
import com.github.osinn.log.starter.Ip2RegionProperties;
import com.github.osinn.log.utils.AddressUtils;
...
public class HandleLogService extends AbstractHandleLogService {
    ...
    public void handleLog(JoinPoint joinPoint, SysLogDTO sysLog, String ipAddress, String requestUri, String requestType, String headerUserAgent) {
        ...
        if (!ip2RegionProperties.isEnabled()) {
            address = !StringUtils.hasLength(ip2RegionProperties.getIpUrl()) ? "未知" : AddressUtils.getRealAddressByIp(ipAddress);
        } else {
            IpInfo ipInfo = null;
            try {
                ipInfo = ip2RegionOfSearcher == null ? null : ip2RegionOfSearcher.search(ipAddress);
            } catch (Exception e) {
